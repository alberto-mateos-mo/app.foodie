...
golem::fill_desc(
  pkg_name = "app.foodie", # The Name of the package containing the App 
  pkg_title = "app.foodie", # The Title of the package containing the App 
  pkg_description = "A foodie's journal.", # The Description of the package containing the App 
  ...
  repo_url = "https://github.com/alberto-mateos-mo/app.foodie.git" # The (optional) URL of the GitHub Repo
)     
...
#golem::use_favicon() # I'll probably want to use a favicon later
